...
# Introduction
In this milestone assignment we are building out our Angular Web Application based on our wireframes.

# Screen Recording
- [Youtube Link](https://youtu.be/kpCyWnKMsOc)

# Powerpoint Presentation
- [File Download](./Presentation.pptx)
- [Online Link](https://mygcuedu6961-my.sharepoint.com/:p:/g/personal/rcornidez_my_gcu_edu/IQCIsSxYovflQrZO5Ipt6I5AAWtVBEOaXOfo5nz0koXlYAE?e=9WRxmh)

# Updates Made
| Component | Description |
|-----------|-------------|
| Dashboard | I didnt have the full design layed out in the wireframe, I was able to descern a meaningful design as I was working with the flow and components.|
| API keys Response Object | I wanted to display the created_at field in the frontend so I had to adujust the API controller layer. |
...
graph TD
    ...
    Dashboard --> HowToGuides[How To Guides]
    Dashboard --> FeatureVoting[Feature Voting]
    Dashboard --> Keys
    Dashboard --> Account
    Dashboard --> Billing
...
*The landing page has two sections: the call-to-action and pricing section*

![Landing Page Wireframe Screenshot](screenshots/wireframe/landing.png)

## Sign Up / Login

*The Sign Up/ Login page has a dynamic form that will either have two fields for logging in or three fields for signing up.*

![Signup/Login Page Wireframe Screenshot](screenshots/wireframe/signup-login.png)

## Dashboard

*The Dashboard page has a navigation bar to the left and a content section on the right. The content of these links are fairly minimal so they will navigate to sections using css ids (fragments) instead of separate pages.*

![Dashboard Page Wireframe Screenshot](screenshots/wireframe/dashboard.png)
...
## / (Landing Page)
### Desktop
![Landing Page Screenshot](screenshots/app/desktop/landing.png)

### Mobile
![Landing Page Screenshot](screenshots/app/mobile/landing.jpg)

## /login
### Desktop
![Login Page Screenshot](screenshots/app/desktop/login.png)

### Mobile
![Login Page Screenshot](screenshots/app/mobile/login.jpg)

## /dashboard/resources#getting_started
### Desktop
![Getting Started Page Screenshot](screenshots/app/desktop/getting_started.png)

### Mobile
![Getting Started Page Screenshot](screenshots/app/mobile/getting_started.jpg)

## /dashboard/resources#how_to_guides
### Desktop
![How To Guides Page Screenshot](screenshots/app/desktop/how_to_guides.png)

### Mobile
![How To Guides Page Screenshot](screenshots/app/mobile/how_to_guides.jpg)

## /dashboard/features
### Desktop
![Feature Voting Page Screenshot](screenshots/app/desktop/features.png)

### Mobile
![Feature Voting Page Screenshot](screenshots/app/mobile/features.jpg)

## /dashboard/settings (#keys, #account, and #billing fragments)
### Desktop
![Settings Page Screenshot](screenshots/app/desktop/settings.png)

### Mobile
![Settings Page Screenshot](screenshots/app/mobile/settings1.jpg) 
![Settings Page Screenshot](screenshots/app/mobile/settings2.jpg)
...
# Conclusion
This assignment was frontend focused. I was able to dive into angular syntax because I needed to create pages, components, services, interceptors, and utilities. I was also able to setup routing with fragments. The template, service, css design structure of Angular is interesting and separates concerns really well. Most of my background has been React focused where there isnt as much structure so this was an interesting experience.
